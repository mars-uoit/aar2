...
int main(int argc, char **argv) {
    ...
    velocityL = n.advertise<roboteq_msgs::Command>("LeftMid/cmd", 5);
    ...
    message_filters::Subscriber<roboteq_msgs::Feedback> left_sub(n, "LeftMid/feedback", 1);
    message_filters::Subscriber<roboteq_msgs::Feedback> right_sub(n, "RightMid/feedback", 1);
